...
const SetStyle = (data) => {
    ...
    document.querySelector(':root').style.setProperty('--unselectable', data.Style.unselectable);
    document.querySelector(':root').style.setProperty('--unselectableBorder', data.Style.unselectableBorder);
}
